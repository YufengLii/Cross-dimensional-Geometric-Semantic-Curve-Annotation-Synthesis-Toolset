...
#include "../trianglemesh-master/trimeshview.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TriMeshView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TriMeshView_t qt_meta_stringdata_TriMeshView = {
    {
QT_MOC_LITERAL(0, 0, 11), // "TriMeshView"
QT_MOC_LITERAL(1, 12, 8), // "autospin"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "TriMeshView\0autospin\0"
};
...
void TriMeshView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TriMeshView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject TriMeshView::staticMetaObject = { {
    &QGLWidget::staticMetaObject,
    qt_meta_stringdata_TriMeshView.data,
    qt_meta_data_TriMeshView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *TriMeshView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TriMeshView.stringdata0))
